    ...
    <div className="p-4">
      ...
      <div className="text-center flex items-center justify-around mt-8">
        <button
          ...
          className="py-2 w-40 text-white hover:bg-error/10 px-4 rounded-md bg-error font-bold"
          type="button"
          onClick={
            isDeleteBoard
              ? deleteBoardHandler
        ...
        <button
          ...
          className="py-2 w-40 font-bold hover:bg-error/10 bg-gray/50 duration-300 px-4 rounded-md"
          type="button"
          onClick={handleClose}
        >
          Cancel
